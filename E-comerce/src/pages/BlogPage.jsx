    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-12">
          ...
          {/* Categories */}
          <div className="w-full md:w-auto flex space-x-2 overflow-x-auto scrollbar-hide pb-2">
            {categories.map((category) => (
              <button
                key={category}
                onClick={() => setActiveCategory(category)}
        ...
        {/* Load More */}
        <div className="text-center mt-12">
          <button className="px-6 py-3 bg-white text-blue-600 border border-blue-600 rounded-lg hover:bg-blue-50 font-medium">
            Load More Equipment
          </button>
        </div>
      </section>
      ...
      <section className="bg-gray-100 py-16">
        <div className="text-center max-w-4xl mx-auto px-4">
          ...
          <p className="text-gray-600 mb-8">Get latest news & updates right to your inbox.</p>
          <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            <input
              type="email"
              placeholder="Your email address"
              className="flex-grow px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500"
            />
      ...
      {selectedBrochure && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 p-4">
          <div className="bg-white rounded-lg w-full max-w-3xl p-6 max-h-[90vh] overflow-y-auto relative">
            <button
              onClick={() => setSelectedBrochure(null)}
